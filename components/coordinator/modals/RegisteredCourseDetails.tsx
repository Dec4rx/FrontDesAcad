...
const RegisteredCourseDetails: React.FC<RegisteredCourseDetails> = ({
    modalVisible,
    setModalVisible,
    courseData,
}) => {
    // Formatear las fechas a un formato legible
    const formattedStartDate = courseData.startDate
        ? new Date(courseData.startDate).toLocaleDateString()
        : 'Fecha no válida';

    const formattedEndDate = courseData.endDate
        ? new Date(courseData.endDate).toLocaleDateString()
        : 'Fecha no válida';

    const formattedDateRegistration = courseData.dateRegistration
        ? new Date(courseData.dateRegistration).toLocaleDateString()
        : 'Fecha no válida';
            ...
            <ScrollView>
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        {/* Renderiza la información del curso */}
                        <View style={styles.textRow}>
                            <Text style={[styles.modalText, { fontWeight: 'bold' }]}>
                                Nombre del Curso:
                            </Text>
                            <Text style={styles.modalText}>{' '+courseData.courseName}</Text>
                        </View>
                        <View style={styles.textRow}>
                            <Text style={[styles.modalText, { fontWeight: 'bold' }]}>
                                Departamento o Academia que Propone:
                            </Text>
                        ...
                        <View style={styles.textRow}>
                            ...
                            <Text style={styles.modalText}>{' '+formattedStartDate}</Text>
                        </View>
                        <View style={styles.textRow}>
                            <Text style={[styles.modalText, { fontWeight: 'bold' }]}>
                                Fecha de Término:
                            </Text>
                            <Text style={styles.modalText}>{' '+formattedEndDate}</Text>
                        </View>
                        <View style={styles.textRow}>
                            <Text style={[styles.modalText, { fontWeight: 'bold' }]}>
                        ...
                        <View style={styles.textRow}>
                            ...
                            <Text style={styles.modalText}>{' '+formattedDateRegistration}</Text>
                        </View>
                        <View style={styles.textRow}>
                            <Text style={[styles.modalText, { fontWeight: 'bold' }]}>
                                Capacidad:
